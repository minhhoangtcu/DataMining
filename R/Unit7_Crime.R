...
LatLonCountsNoZero = subset(LatLonCounts, Freq > 0)
str(LatLonCountsNoZero)
...
ggmap(chicago) + geom_tile(data = LatLonCountsNoZero, aes(x = Long, y = Lat, alpha = Freq), fill="red")
